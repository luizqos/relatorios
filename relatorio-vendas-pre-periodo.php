...
$planilha = "gerar-vendas-pre-periodo.php?datai=$datainicio&dataf=$datafim";
...
AND ((A.DataInsert BETWEEN '$datainicio 00:00:00.000' AND '$datafim 23:59:59.999') OR (A.Data BETWEEN '$datainicio 00:00:00.000' AND '$datafim 23:59:59.999'))";
*/
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <h3 class="card-title">Relatório de Vendas - Pre</h3>
            </div>
            <!-- /.card-header -->
          ...
          <th>DATA ACEITE</th>
            ...
            <td><?php echo strtoupper($r['DataAceite']); ?></td>
					</tr>
				<?php } ?>
                </tfoot>
              </table>
