...
$planilha = "gerar-recorrencia-ativa-periodo.php?datai=$datainicio&dataf=$datafim";
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <h3 class="card-title">Relatório de Recorrencia Ativa</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body table-responsive p-0">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
					...
					<th>SETOR USUARIO RECORRENCIA</th>
					<th>VENDEDOR</th>
				...
				?>
					<tr>
						...
						<td><?php echo strtoupper($r['SETOR_USUARIO']); ?></td>
						<td><?php echo strtoupper($r['USUARIO_REC']); ?></td>
						<td><?php echo strtoupper($r['SETOR_USUARIO_REC']); ?></td>
