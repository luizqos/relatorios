...
$planilha = "gerar-vendas-carencia.php?datai=$datainicio&dataf=$datafim";
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <h3 class="card-title">Relatório de Vendas - Carência</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body table-responsive p-0">
              <table id="example1" class="table table-bordered table-striped text-nowrap">
				...
				<tr>
					...
					<th>CLIENTE</th>
					<th>CIDADE</th>
					<th title ="DATA DE CADASTRO" >CADASTRO</th>
					<th>CARENCIA</th>
					<th>ACEITE</th>
					<th>TIPO ACEITE</th>
					<th>DATA DO ACEITE</th>
					<th title ="VALOR DA INSCRIÇÃO">VALOR INSCRIÇÃO</th>
					<th title ="PAGAMENTO DA INSCRIÇÃO">PGTO INSCRIÇÃO</th>
					<th title ="TIPO DE COBRANÇA">COBRANÇA</th>
				</tr>
                </thead>
                <tbody>
					<?php
