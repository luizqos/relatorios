...
try{
	...
	IIF((Extrato.DataHora IS NOT NULL), '', (CONVERT(VARCHAR(10),(select DataHora from Extrato WHERE Referencia IN ('1', '01') and Inscricao = Associados.Inscricao), 103))) AS DATA_BAIXA,
...
WHERE Inscricao.Pagamento between '$datainicio 00:00:00.000' AND '$datafim 23:59:59.999'
GROUP BY Mensalidade.Valor, Associados.Inscricao, Associados.Nome, Vendedores.Nome, Coordenadores.Nome, Associados.Data, Associados.TipoAceite, Associados.DataAceite, Inscricao.Valor, extrato.TipoDoc, TipoCobranca.TipCobDescricao, Cidades.Nome, Inscricao.Pagamento, Associados.Aceite, Extrato.DataHora
...
<head>
    ...
    foreach($result as $res){
		...
		$dadosXls .= "          <td>".$res['FORMA_PGTO']."</td>";
		$dadosXls .= "          <td>".$res['VALOR_MENSALIDADE']."</td>";		
